...
static esp_err_t esp_vision_matouch_ai_28_draw_bitmap(esp_lcd_panel_t *panel,
                                                      int x_start,
                                                      int y_start,
                                                      int x_end,
                                                      int y_end,
                                    ...
                                    esp_lcd_panel_handle_t *panel_handle)
{
    ...
    (*panel_handle)->draw_bitmap = esp_vision_matouch_ai_28_draw_bitmap;
    return ESP_OK;
}

static int esp_vision_matouch_ai_28_camera_init(void *config,
                                                int config_size,
                                                void **device_handle)
{
    (void)config;
...
static int esp_vision_matouch_ai_28_camera_deinit(void *device_handle)
{
    (void)device_handle;
...
CUSTOM_DEVICE_IMPLEMENT(camera,
                        esp_vision_matouch_ai_28_camera_init,
                        esp_vision_matouch_ai_28_camera_deinit);
