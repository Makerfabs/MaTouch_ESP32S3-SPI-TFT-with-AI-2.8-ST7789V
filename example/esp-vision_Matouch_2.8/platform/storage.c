...
static esp_err_t esp_vision_storage_mount_sdcard(void)
{
    ...
    host.slot = ESP_VISION_SDCARD_SPI_HOST;
    host.max_freq_khz = ESP_VISION_SDCARD_SPI_FREQ_KHZ;
    ...
    slot.host_id = ESP_VISION_SDCARD_SPI_HOST;
    slot.gpio_cs = ESP_VISION_SDCARD_SPI_CS_PIN;
    ...
    ret = esp_vfs_fat_sdspi_mount(ESP_VISION_SDCARD_MOUNT_PATH,
                                  &host,
                                  &slot,
                                  &mount_config,
                                  &s_sdcard);
